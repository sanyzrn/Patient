...
> **رمز پیش‌فرض مدیر:** در اولین اجرا رمز `nafas-admin-2026` ساخته می‌شود. حتماً از بخش **تنظیمات ← تغییر رمز عبور** در پنل مدیریت آن را تغییر دهید. لاگین در برابر حملهٔ brute-force با throttle محافظت می‌شود.
